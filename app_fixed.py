...
with tab_glossary:
    ...
    if st.session_state["glossary"]:
        ...
        # ฝัง _idx ก่อน filter เพื่อให้ได้ real index ที่ถูกต้องแม้มีคำซ้ำ
        indexed_glossary = [dict(g, _idx=i) for i, g in enumerate(st.session_state["glossary"])]
        filtered_g = [g for g in indexed_glossary
